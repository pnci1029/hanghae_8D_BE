...
public class ComfortUtils {
    ...
    public String badWordsFilter(String wordsCheck) {
        List<String> badWords = Arrays.asList("홍창형","18년","18놈","18새끼","ㄱㅐㅅㅐㄲl","ㄱㅐㅈㅏ","가슴만져","가슴빨아","가슴빨어","가슴조물락","가슴주물럭","가슴쪼물딱","가슴쪼물락","가슴핧아","가슴핧어","강간","개가튼년","개가튼뇬","개같은년","개걸레","개고치",
                ...
                "sex");
        if (badWords.get(0).contains(wordsCheck)) {
            throw new CustomException(ErrorCode.BADWORDS_EXCEPTION);
        }

        return String.valueOf(Arrays.asList(badWords).contains(wordsCheck));
    }
